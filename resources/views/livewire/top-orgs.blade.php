    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-white/10">
            ...
            <tr>
                ...
                <th scope="col" class="px-6 py-3 text-right text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-300 align-middle">Total Kills</th>
            ...
            @forelse ($orgs as $i => $org)
                @if($org->spectrum_id !== \App\Models\Organization::ORG_NONE)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-200 text-right align-middle whitespace-nowrap font-mono">{{ $org->total_kills }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-200 text-right align-middle whitespace-nowrap font-mono">{{ \Illuminate\Support\Number::format($org->average_kills_per_player, 2) }}</td>
                    </tr>
                @endif
            @empty
                <tr>
