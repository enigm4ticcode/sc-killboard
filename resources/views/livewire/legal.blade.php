<div id="legal-info-wrapper" class="container mx-auto px-4 py-12 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 shadow-xl dark:shadow-2xl rounded-lg mt-8 mb-0">
