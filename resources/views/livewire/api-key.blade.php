...
<form class="min-w-full p-4 bg-white dark:bg-[#0d1424] rounded-xl shadow-2xl space-y-6" wire:submit.prevent="save">
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#060a14] border border-dashed border-gray-300 dark:border-[#0f1828] rounded-lg shadow-inner">
    ...
    <div class="space-y-4">
        ...
        <div id="code" class="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#060a14] border border-dashed border-gray-300 dark:border-[#0f1828] rounded-lg shadow-inner">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button type="button" onclick="copyCode(event)" class="p-2 rounded-md hover:bg-gray-200 dark:hover:bg-[#111b2d] text-gray-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition duration-150 ease-in-out cursor-pointer flex-shrink-0" title="Copy code to clipboard">
